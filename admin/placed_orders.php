...
<head>
   ...
   <title>Gordos Tech 🦍 | Compras</title>
   ...
   <div class="box">
      ...
      <form action="" method="post">
        ...
        <div class="flex-btn">
         ...
         <a href="placed_orders.php?delete=<?= $fetch_orders['id']; ?>" class="delete-btn" onclick="return confirm('Queres borrar esta compra?');">Borrar</a>
        </div>
      </form>
   </div>
   <?php
