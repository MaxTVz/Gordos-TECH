...
<head>
   ...
   <title>Gordos Tech 🦍 | Actualizar perfiles</title>
...
<section class="form-container">
   ...
   <form action="" method="post">
      ...
      <input type="text" name="name" value="<?= $fetch_profile['name']; ?>" required placeholder="Ingresa tu usuario" maxlength="20"  class="box" oninput="this.value = this.value.replace(/\s/g, '')">
