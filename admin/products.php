   ...
   if($select_products->rowCount() > 0){
      ...
      if($insert_products){
         if($image_size_01 > 2000000 OR $image_size_02 > 2000000 OR $image_size_03 > 2000000){
            $message[] = 'La medida de la imagen es demasiada grande!';
         }else{
...
<head>
   ...
   <title>Gordos Tech 🦍 | Productos</title>
   ...
   <form action="" method="post" enctype="multipart/form-data">
      <div class="flex">
         <div class="inputBox">
            ...
            <input type="text" class="box" required maxlength="100" placeholder="Introducir nombre del producto" name="name">
         </div>
         <div class="inputBox">
            <span>Precio del Producto (requerido)</span>
            <input type="number" min="0" class="box" required max="9999999999" placeholder="Introducir precio del producto"if(this.value.length == 10) return false;" name="price">
         </div>
        <div class="inputBox">
        ...
        <div class="inputBox">
         ...
         <div class="inputBox">
            ...
            <textarea name="details" placeholder="Introducir detalles del producto" class="box" required maxlength="500" cols="30" rows="10"></textarea>
         </div>
      </div>
...
<section class="show-products">
   ...
   <div class="box">
      ...
      <div class="flex-btn">
         ...
         <a href="products.php?delete=<?= $fetch_products['id']; ?>" class="delete-btn" onclick="return confirm('delete this product?');">Borrar</a>
      </div>
   </div>
   <?php
         }
