...
if(isset($_POST['submit'])){
   ...
   if($old_pass == $empty_pass){
      ...
      if($new_pass != $empty_pass){
         ...
         $message[] = 'contraseña exitosamente cambiada!';
      }else{
      }
   }
...
<head>
   ...
   <title>Actualizar tu Perfil</title>
...
<section class="form-container">
   ...
   <form action="" method="post">
      <h3><b>ACTUALIZA TU PERFIL</b></h3>
      <input type="hidden" name="prev_pass" value="<?= $fetch_profile["password"]; ?>">
      <input type="text" name="name" required placeholder="ingresa tu usuario" maxlength="20"  class="box" value="<?= $fetch_profile["name"]; ?>">
