...
<section class="orders">
   ...
   <h1 class="heading">Compras Hechas</h1>

   <div class="box-container">

   <?php
      if($user_id == ''){
         echo '<p class="empty">Por favor, inicia sesión para ver tus compras</p>';
      }else{
   ...
   ?>
   <div class="box">
      <p>Compra hecha el : <span><?= $fetch_orders['placed_on']; ?></span></p>
      ...
      <p>Tus compras : <span><?= $fetch_orders['total_products']; ?></span></p>
   ...
   <?php
         ...
         echo '<p class="empty">No hay compras hechas</p>';
      }
      }
   ?>
